from MagmaPandas.geochemistry import volatile_solubility_models as vsm
...
def _get_solubility_model(model_name: str=None, species: str=None) -> vsm.Solubility_model:
...
def calculate_saturation(oxide_wtPercents, solubility_model: vsm.Solubility_model=None, **kwargs):
    """
    Docstring
    """
    if solubility_model is None:
        solubility_model = _get_solubility_model()
...
def calculate_solubility(oxide_wtPercents, P_bar, solubility_model=None, **kwargs):
    """
    Docstring
    """
    if solubility_model is None:
        ...
        solubility_model = _get_solubility_model(*solubility_model)
