...
def read_olivine(file: str, *args, index_col: List[str], keep_columns: List[str] = [], **kwargs):
    """
    Docstring
    """
    ...
    return olivine(df, *args, keep_columns=keep_columns, calculate_total=True, **kwargs)
